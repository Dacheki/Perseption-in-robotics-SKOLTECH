...
def main():
    ...
    alphas = np.array([float(alpha) for alpha in args.alphas]) ** 2
    # variance of noise R proportional to alphas, see tools/tasks@get_motion_noise_covariance()
    ...
    movie_writer = None
    if write_movie:
        get_ff_mpeg_writer = PillowWriter(fps=30)
